...
<body class="dashboard-page">
    <div class="app-shell">
        ...
        <main class="dashboard-main">
            ...
            <section class="product-library"><div class="section-heading"><h2>محصولات تو</h2><div class="section-actions"><input class="library-search" data-product-search type="search" placeholder="جست‌وجوی محصول" aria-label="جست‌وجوی محصول"><button class="small-button" data-open-product>+ محصول جدید</button></div></div><div class="product-grid" data-product-grid><p class="empty-state">در حال بارگذاری کتابخانه...</p></div><div class="library-pagination" data-product-pagination hidden><button class="small-button" data-product-prev>قبلی</button><span data-product-page></span><button class="small-button" data-product-next>بعدی</button></div></section>
            ...
            <section class="notification-center"><div class="section-heading"><h2>اعلان‌ها</h2><button class="small-button" data-read-all-notifications>خواندن همه</button></div><div class="notification-list" data-notification-list><p class="empty-state">در حال بارگذاری...</p></div></section>
    ...
    <div class="product-modal" data-product-modal hidden><div class="modal-backdrop" data-close-product></div><section class="auth-panel product-panel" role="dialog" aria-modal="true"><button class="close-button" data-close-product aria-label="بستن">×</button><p class="eyebrow">PRODUCT LIBRARY / ۰۱</p><h2 data-product-form-title>محصول جدید</h2><p class="modal-copy">اطلاعات محصول را ویرایش یا تصویر جدید اضافه کن.</p><form data-product-form><label>نام محصول<input name="name" required placeholder="مثلاً عطر بهار"></label><label>توضیح کوتاه<input name="description" placeholder="رنگ، جنس یا نکته مهم"></label><label class="file-label">عکس محصول<input name="image" type="file" accept="image/jpeg,image/png,image/webp"></label><p class="form-message" data-product-message role="alert"></p><button class="primary-button full-button" type="submit" data-product-submit>افزودن محصول <span>←</span></button></form></section></div>
</body>
</html>
