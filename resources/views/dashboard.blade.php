...
<body class="dashboard-page">
    <div class="app-shell">
        ...
        <main class="dashboard-main">
            ...
            <section class="product-library"><div class="section-heading"><h2>محصولات تو</h2><div class="section-actions"><input class="library-search" data-product-search type="search" placeholder="جست‌وجوی محصول" aria-label="جست‌وجوی محصول"><button class="small-button" data-open-product>+ محصول جدید</button></div></div><div class="product-grid" data-product-grid><p class="empty-state">در حال بارگذاری کتابخانه...</p></div></section>
